...
public class RemoveGreaterCommand implements Command {
    ...
    public void execute(String[] args, BufferedReader input) throws Exception {
        ...
        System.out.println("Enter reference person (all your greater persons will be removed).");
        try {
            // read reference (same as AddCommand)
            ...
            System.out.println("Removed " + toRemove.size() + " of your greater objects.");
        } catch (Exception e) {
